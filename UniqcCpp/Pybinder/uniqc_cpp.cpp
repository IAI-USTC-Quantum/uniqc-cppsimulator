...
PYBIND11_MODULE(uniqc_cpp, m)
{
	...
	py::class_<uniqc::StatevectorSimulator>(m, "StatevectorSimulator")
		...
		.def("qram", &uniqc::StatevectorSimulator::qram, py::arg("addr_qubits"), py::arg("data_qubits"), py::arg("data_array"), py::arg("control_qubits") = std::vector<size_t>{})
		.def("measure_qubit", &uniqc::StatevectorSimulator::measure_qubit, py::arg("qn"))
		.def("reset_qubit", &uniqc::StatevectorSimulator::reset_qubit, py::arg("qn"))
	...
	py::class_<uniqc::DensityOperatorSimulator>(m, "DensityOperatorSimulator")
		...
		.def("qram", &uniqc::DensityOperatorSimulator::qram, py::arg("addr_qubits"), py::arg("data_qubits"), py::arg("data_array"), py::arg("control_qubits") = std::vector<size_t>{})
		.def("measure_qubit", &uniqc::DensityOperatorSimulator::measure_qubit, py::arg("qn"))
		.def("reset_qubit", &uniqc::DensityOperatorSimulator::reset_qubit, py::arg("qn"))
