...
PYBIND11_MODULE(uniqc_cpp, m)
{
	...
	py::class_<uniqc::StatevectorSimulator>(m, "StatevectorSimulator")
		...
		.def("qram", &uniqc::StatevectorSimulator::qram, py::arg("addr_qubits"), py::arg("data_qubits"), py::arg("data_array"))
	...
	py::class_<uniqc::DensityOperatorSimulator>(m, "DensityOperatorSimulator")
		...
		.def("qram", &uniqc::DensityOperatorSimulator::qram, py::arg("addr_qubits"), py::arg("data_qubits"), py::arg("data_array"))
